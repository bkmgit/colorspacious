...
def test_check_node():
    ...
    tc().assertRaises(AssertionError, check_node, {}, [])
    check_node({"name": "asdf"}, [])
    tc().assertRaises(AssertionError, check_node, {"name": 1}, [])
...
def test_check_edge():
    ...
    for bad in [
        ...
        tc().assertRaises(AssertionError, check_edge, bad)
...
def test_check_path():
    ...
    for bad in [
        ...
        tc().assertRaises(AssertionError, check_path, bad)
...
def test_transform_kwargs():
    ...
    tc().assertRaises(AssertionError, transform_kwargs,
                     {"name": "start", "a": 1},
                     {"name": "end",   "a": 2})
